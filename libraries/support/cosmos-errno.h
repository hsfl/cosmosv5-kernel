...
/*!
 * \file cosmos-errno.h
 * \brief COSMOS error code definitions.
 * \ingroup cosmos_kernel_config
 * \defgroup cosmos_errno Error Codes
 *
 * Defines the full set of signed integer error codes used by COSMOS functions.
 * Error codes are negative integers grouped by subsystem. Include this header
 * whenever a function returns or tests a COSMOS-specific error condition.
 */
