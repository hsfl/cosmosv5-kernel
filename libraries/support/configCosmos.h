...
/*!
 * \file configCosmos.h
 * \brief Platform detection, system includes, and COSMOS-wide macros.
 * \ingroup cosmos_kernel_config
 * \defgroup cosmos_config Configuration
 *
 * The top-level configuration header for COSMOS. It detects the build platform
 * (Linux, macOS, Windows), pulls in necessary system headers, and defines
 * project-wide macros and type aliases. Every other COSMOS header transitively
 * includes this file, so it must remain dependency-free.
 */
