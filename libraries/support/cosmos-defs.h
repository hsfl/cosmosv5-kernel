...
/*!
 * \file cosmos-defs.h
 * \brief STL container type aliases used across COSMOS.
 * \ingroup cosmos_kernel_config
 * \defgroup cosmos_defs COSMOS Definitions
 *
 * Declares short-hand type aliases for common STL container specializations
 * (e.g., ByteVector, StringList) that appear throughout the COSMOS codebase.
 * Centralising them here avoids repetition and ensures consistency.
 */
